<head>
    <title>Kruitnagel - Product Wijzigen</title>
</head>
...
<div>
    <form action="dataverwerken.php" method="post" class="frmDetail">
        ...
        <div class="form-group">
            ...
            <input type="number" name="product_id" id="product_id" value="<?php echo $product['product_id']; ?>" readonly class="form-control">
        </div>
        <div class="form-group">
            <label for="product_naam">Naam:</label>
            <input type="text" name="product_naam" id="product_naam" value="<?php echo $product['product_naam']; ?>" class="form-control">
        </div>
        <div class="form-group">
            <label for="prijs">Prijs:</label>
            <input type="text" name="prijs" id="prijs" value="<?php echo $product['prijs']; ?>" class="form-control">
        </div>
        <div class="form-group">
            <label for="categorie_id">Categorie ID:</label>
            <input type="number" name="categorie_id" id="categorie_id" value="<?php echo $product['categorie_id']; ?>" class="form-control">
        </div>
        <div class="form-group">
            <label for="aantal">Voorraad:</label>
            <input type="number" name="aantal" id="aantal" value="<?php echo $product['aantal']; ?>" class="form-control">
        </div>
        <div class="submitbtn">
